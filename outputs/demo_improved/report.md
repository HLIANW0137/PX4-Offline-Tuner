...
- Output: `outputs\demo_improved`

## Summary
- Roll best preset is 'aggressive' (quality=0.50, fit=0.72, score=0.0).
- Pitch best preset is 'aggressive' (quality=0.50, fit=0.71, score=0.0).
- Yaw best preset is 'aggressive' (quality=0.50, fit=0.70, score=0.0).
...
- `conservative`: Kp=0.09706, Ki=0.71332, Kd=0.00662, risk=low
  - Simulated rise=infs, settle=infs, overshoot=0.00%, score=0.00, stable=True
